...
## [Unreleased]
### Removed
- The gallery (bucket list and in-bucket file browsing). The home screen now
  only offers opening a file through the system file picker; opening from
  other apps (ACTION_VIEW) still works. Storage permissions are no longer
  requested.
